...
srun bash -lc "source '$VENV_DIR/bin/activate' && echo 'Using python: ' \$(which python) && python -c 'import orion; print(\"orion:\", getattr(orion,\"__file__\",None))' && cd examples && python -u run_perso.py"
